...
select 
  ...
  count( case when t2.descMedal in ('#YADINHO - Eu Fui!', 'Missão da Tribo', 'Tribo Gaules')  then t1.idMedal end) as qtMedalhaTribo,
  ...
  count( case when t2.descMedal in ('Membro Plus', 'Membro Premium') 
